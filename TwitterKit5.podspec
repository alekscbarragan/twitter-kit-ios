Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/alekscbarragan/twitter-kit-ios"
  s.documentation_url = "https://github.com/alekscbarragan/twitter-kit-ios/wiki"
  s.social_media_url = "https://taoren.me"
  s.authors = "Aleks C."
  s.platform = :ios, "14.0"
  s.source = { :http => "https://github.com/alekscbarragan/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
